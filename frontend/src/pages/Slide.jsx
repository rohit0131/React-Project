            ...
            <Carousel
                ...
                itemClass="carousel-item-padding-40-px">
                {
                    products.map((product, index) => (
                        <Link key={index} to={`/product/view/${product._id}`} style={{ textDecoration: 'none'   }} className=''>
                            <Box textAlign="center" style={{ padding: '25px 15px' }}>
                            <div className=' flex flex-col lg:flex-row-reverse gap-2'>
                            <div className='flex justify-center items-center h-[150px] w-[150px]  relative m-0 '>
                                            <img src={product.productImage} className='h-full w-full object-scale-down mix-blend-multiply' />
                                        </div>
                                        </div>
