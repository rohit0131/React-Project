                  ...
                  {loading ? (
                    ...
                    <div className="flex flex-col gap-1">
                      ...
                      <div className="flex items-center gap-2 lg:text-3xl  my-1">
                        <p className="text-black-500 font-medium text-2xl lg:text-3xl">
                          ₹
                          {productDetails &&
                            productDetails.price &&
                            productDetails.price.cost}
                        </p>
                        <p className="text-slate-300 line-through font-medium text-2xl lg:text-3xl">
                          ₹
                          {productDetails &&
                            productDetails.price &&
                            productDetails.price.mrp}
                        </p>
                        <p className="text-green-500 font-small text-xl ">
                          {productDetails &&
                            productDetails.price &&
                      ...
                      <div className="flex items-center gap-3 my-2"></div>
