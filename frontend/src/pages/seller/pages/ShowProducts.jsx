                      ...
                      >
                        ...
                        <div className='w-full min-w-[280px]  md:min-w-[300px] max-w-[280px] md:max-w-[300px]  bg-white rounded-sm shadow ' style={{ boxShadow: '0 4px 8px rgba(0, 0, 0, 0.3)' }}>
                         ...
                         <div className='p-4 grid gap-3'>
                             ...
                             <button className='border-2 border-red-600 rounded px-3 py-1 min-w-[120px] font-medium text-white bg-red-600 hover:text-red-600 hover:bg-white'   onClick={() => deleteHandler(data._id, "DeleteProduct")}>Delete</button>
                             <button className='border-2 border-green-600 rounded px-3 py-1 min-w-[120px] font-medium text-white bg-green-600 hover:text-green-600 hover:bg-white'   onClick={() => navigate("/Seller/products/product/" + data._id)}>View</button>
