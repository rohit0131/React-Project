                        ...
                        >
                            <CartItem>
                                ...
                                <ProductDetails>
                                    ...
                                    {data.category === 'Rental Equipments' ? 'Original Rent: ' : 'Original Price: '}
                                   ₹{data.category === 'Rental Equipments' ?data.price.mrp : data.price.mrp}
                                    ...
                                    <Typography variant="subtitle2">
                                    {data.category === 'Rental Equipments' ? 'Per Day Rent: ' : 'Final Price: '}
                                   ₹{data.category === 'Rental Equipments' ?data.price.cost: data.price.cost}
                                        {/* Final Price: ₹{data.price.cost} */}
                                    </Typography>
                                    <Typography variant="subtitle2">
                                    {data.category === 'Rental Equipments' ? 'Day: ' : 'Quantity:'}
                                   {data.category === 'Rental Equipments' ?data.quantity: data.quantity}
                                        {/* Quantity: {data.quantity} */}
                                    </Typography>
                                    <Typography variant="subtitle2">
                                   
                                    {data.category === 'Rental Equipments' ? 'Day Wise Cost: ' : 'Total: '}
                                   ₹{data.category === 'Rental Equipments' ?(data.quantity * data.price.cost) : (data.quantity * data.price.cost)}
                                    </Typography>
                                    <ButtonContainer>
                                        <Button
                                            variant="outlined"
                                    ...
                                    <ButtonContainer>
                                        ...
                                        {data.category === 'Rental Equipments' ? (
                                        <Button
                                            variant="contained"
                                            color="success"
                                            sx={{ mt: 2 }}
