                ...
                <Toolbar disableGutters>
                    ...
                    <HomeContainer>
                        ...
                        >
                            <NavLogo
                                ...
                                onClick={homeHandler}
                            >
                              <GiQueenCrown  sx={{ display: { xs: 'none', md: 'flex' }, mr: 1 }} size={30} style={{color: "black ",marginRight:"10px" }} />
                    ...
                    <HomeContainer>
                        ...
                        >
                            ...
                            >
                         <GiQueenCrown  sx={{ display: { xs: 'none', md: 'flex' }, mr: 1 }} size={30} style={{color: "black ",marginRight:"10px" }} />
                                    <h3 className='text-black'>Shetkari</h3>
...

                    {
                     ...
                     <Link to={"./scanner"} className='text-2xl relative mr-5'>
                         <span> <AiOutlineScan size={30} style={{color: "black" }} /></span>
                    ...
                    {currentRole === null &&
                        <Box sx={{ flexGrow: 0, display: { xs: 'none', md: 'flex' }, }}>
                            ...
                            >
                                <FaRegUserCircle size={30} style={{color: "black" }}/>
                            </Button>
                            <Menu
                        ...
                        <Box sx={{ flexGrow: 0, display: 'flex' }}>
                            <Tooltip title="Cart">
                                <IconButton onClick={handleOpenCart} sx={{ width: "4rem", color: 'inherit', p: 0 }}>
                                    ...
                                    <FaCartArrowDown sx={{ fontSize: "2rem" }} style={{color: "black" }} />
                                    </Badge>
                                </IconButton>
                            </Tooltip>
